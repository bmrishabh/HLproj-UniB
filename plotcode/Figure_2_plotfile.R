...
###################### Preppeing Data ########################
OE.Data <- loadRData("Data/e-var-mean_0p2-sd_0p1-a0_0p1/rawdata/file.RData") #Over Exploitation Data
NE.Data <- loadRData("Data/e-var-mean_0p2-sd_0p1-a0_0p14/rawdata/file.RData") #Normal Exploitation Data
filname <- "Figure_2.pdf"
