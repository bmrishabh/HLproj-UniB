...
Data.PD <- parsweep.curator("Data/e-var-mean_0p2-sd_0p1-parsweep_d-NoAllee/d/rawdata/file.RData","PD")
Data.noPD <- parsweep.curator("Data/e-var-mean_0p2-sd_0p1-parsweep_d-NoAllee-noPD/d/rawdata/file.RData","noPD")
