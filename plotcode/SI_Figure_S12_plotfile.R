...
Data.PD <- parsweep.curator("Data/b1-var-mean_500-sd_200-ttmin_100-ttmax_900-parsweep_d/d/rawdata/file.RData","PD")
Data.noPD <- parsweep.curator("Data/b1-var-mean_500-sd_200-ttmin_100-ttmax_900-parsweep_d-noPD/d/rawdata/file.RData","noPD")
...
pR1.OE <- pobj + geom_line(aes(y=R1, color=Trait, linetype=type, alpha=type, linewidth=type)) +
  ylab("Equilibrium Resource Density") + scale_y_continuous(expand = c(0,0.1),limits = c(-0.01,35))
#pR1.OE
...
pR.OE <- pobj + geom_line(aes(y=R1+R2, color=Trait, linetype=type, alpha=type, linewidth=type)) +
  ylab("Equilibrium Resource Density") + scale_y_continuous(expand = c(0,0.1),limits = c(-0.01,60))
#pR.OE
