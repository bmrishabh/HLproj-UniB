...
###################### Preppeing Data ########################
OE.Data <- loadRData("Data/e-var-mean_0p2-sd_0p1-a0_0p1-ec_1/rawdata/file.RData") #Over Exploitation Data
NE.Data <- loadRData("Data/e-var-mean_0p2-sd_0p1-a0_0p14-ec_1/rawdata/file.RData") #Normal Exploitation Data
filname <- "SI_Figure_S7.pdf"
...
pN.OE <- p.OE + geom_line(aes(y=N1, color=HL, linetype="1", linewidth="1"), alpha=0.7) + 
  ...
  ylab("Consumer Density") + scale_y_continuous(expand = c(0.01,0.01),limits = c(0,20))
#pN.OE
...
pR.OE <- p.OE + geom_line(aes(y=R1, color=HL, linetype="1", linewidth="1"), alpha=0.7) + 
  ...
  ylab("Resource Density") + scale_y_continuous(expand = c(0.01,0.01),limits = c(0,50))
#pR.OE
...
pNL.OE <- p.OE + geom_line(aes(y=N1+N2, color=HL), linewidth=0.5, alpha=0.7) +
  ylab("Total Consumer Density") + scale_y_continuous(expand = c(0.01,0.01),limits = c(0,30))
#pNL.OE

pRL.OE <- p.OE + geom_line(aes(y=R1+R2, color=HL), linewidth=0.5, alpha=0.7) +
  ylab("Total Resource Density") + scale_y_continuous(expand = c(0.01,0.01),limits = c(0,60))
#pRL.OE
