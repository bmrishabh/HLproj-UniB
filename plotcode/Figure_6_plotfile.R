...
###################### Preppeing Data ########################
OE.Data <- loadRData("Data/p-beta-pos-tradeoff-mean_0p65-sd_0p17-a0_0p1/rawdata/file.RData") #Over Exploitation Data
ONE.Data <- loadRData("Data/p-beta-pos-tradeoff-mean_0p65-sd_0p17-a0_0p16/rawdata/file.RData")
NE.Data <- loadRData("Data/p-beta-pos-tradeoff-mean_0p65-sd_0p17-a0_0p18/rawdata/file.RData") #Normal Exploitation Data
filname <- "Figure_6.pdf"
trait <- "p1"
