...
foldername = "Data/p-beta-pos-tradeoff-mean_0p65-sd_0p17-a0_0p1"
trait = c("p1","beta")
parsweep_trait = c()
...
foldername = "Data/p-beta-pos-tradeoff-mean_0p65-sd_0p17-a0_0p16"
trait = c("p1","beta")
parsweep_trait = c()
...
foldername = "Data/p-beta-pos-tradeoff-mean_0p65-sd_0p17-a0_0p18"
trait = c("p1","beta")
parsweep_trait = c()
...
source("plotcode/Figure_6_plotfile.R")
