# Code to generate data for parameter space plots

# Parameter scan over a0 while epsilon is evolving [~50-55 mins]
rm(list = ls())
source("Bagpack.R")

foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_a0"
trait = c("e")
parsweep_trait = c("a0")
...
foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_b0"
trait = c("e")
parsweep_trait = c("b0")
...
foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_b1"
trait = c("e")
parsweep_trait = c("b1")
...
foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_p"
trait = c("e")
parsweep_trait = c("p1")
...
foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_beta"
trait = c("e")
...
# Parameter scan over epsilon while epsilon is evolving [~30-35 mins]
rm(list = ls())
source("Bagpack.R")

foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_e"
trait = c("e")
...
foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_ec"
trait = c("e")
parsweep_trait = c("ec")
obj <- MCfun_multcases(a0 = 0.1, b0 = 30, b1 = 500, bins=21,
                       p1 = 0.75, beta = 0.75, vartrait = trait, ToffMinMaxPos = c(0,1,TRUE),
...
# Parameter scan over theta while epsilon is evolving [~50-55 mins]
rm(list = ls())
source("Bagpack.R")

foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_theta"
trait = c("e")
...
# Parsweep plots (patch-wise equilibrium density vs parameter values) for no variation cases
source("plotcode/Figure_3_plotfile.R")


# Parsweep plots (patch-wise equilibrium density vs parameter values) for variation in epsilon
source("plotcode/SI_Figure_S9_plotfile.R")
