...
# Parameter scan over d while epsilon is evolving, a0=0.14 [~20-25 mins]
rm(list = ls())
source("Bagpack.R")

foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_d-a0_0p14"
trait = c("e")
parsweep_trait = c("d")
obj <- MCfun_multcases(a0 = 0.14, b0 = 30, b1 = 500, bins=21,
                       ...
                       mu = 0.3, d = seq(0,0.1,0.025), k = 0.003, t0 = 3500, theta = 2, times = seq(0, 8000, 1),
...
foldername = "Data/e-var-mean_0p2-sd_0p1-parsweep_d-a0_0p14-noPD"
trait = c("e")
parsweep_trait = c("d")
obj <- MCfun_multcases(a0 = 0.14, b0 = 30, b1 = 500, bins=21,
                       p1 = 0.75, beta = 0.75, vartrait = trait, ToffMinMaxPos = c(0,1,TRUE),
                       ...
                       e = 0.2, ec = 0.9, C01 = 0.5, C02 = 0.5, C11 = 50, C12 =50,
                       N01 = 4, N02 = 3, R01 = 10, R02 = 10, foldername = foldername,
                       mu = 0.3, d = seq(0,0.1,0.025), k = 0.003, t0 = 3500, theta = 2, times = seq(0, 8000, 0.5),
                       mutations = T, parasweep=parsweep_trait, GeneticMixing=T, Allee = T, HLatEQ = F, savedata = T)

#Plot the figure by sourcing the file which plots it
source("plotcode/SI_Figure_S10_plotfile.R")
